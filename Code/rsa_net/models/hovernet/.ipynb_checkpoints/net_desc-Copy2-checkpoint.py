...
#                 print('u3 from upsample and d2', u3.size(),  d[-2].size())
                u3 = branch_desc[0](u3)
#                 print(u3.size(), 'u3 dec size')#                 
                
                u2 = self.upsample2x(u3) + self.e1(d[-3])
#                 print(u2.size(), 'u2 before dec')
#                 print('u2 from upsample and d1', u2.size(),  d[-3].size())
                u2 = branch_desc[1](u2)
#                 print(u2.size(), 'u2 dec size')#                 
                
                u1 = self.upsample2x(u2) + self.e2(d[-4])
#                 print('u1 from upsample and d0', u1.size(),  d[-4].size())
                u1 = branch_desc[2](u1)
#                 print(u1.size(), 'u1 dec size')#                 
