...
#                         "pretrained": "./logs/results/RESULTS_FOR_RTS_BACKUP/logs/cpm17/rec_preact-CBAM-ECA_k7_cpm17/00_msge2-01/net_epoch=41.tar"
                        'pretrained': None,
                    },
                },
                "target_info": {"gen": (gen_targets, {}), "viz": (prep_sample, {})},
                "batch_size": {"train": 4, "valid": 16,},  # engine name : value
                "nr_epochs": 3,
            },
#             {
#                 "run_info": {
...
#                         # None to start from scratch
#                         "pretrained": -1,
# #                         "pretrained": "./logs/CoNSeP_270_80/rec_CBAMECAk5_consep-tp_preactrelubn_fullData/00_msge2_01/00/net_epoch=50.tar",
